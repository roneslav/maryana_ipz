                    ...
                    <div className="cart__object">
                        ...
                        <div className='cart__texts'>
                            ...
                            <div className='cart__object__strength'>
                                Author: {object.objectData.author}
                            </div>
                        ...
                        <div className='cart__object__right'>
                            <button className='cart__object__increment' onClick={() => handleIncrementAmount(object.objectData.book_id)}>
                                +
                            </button>
                            <div className='cart__object__amount'>
                                {object.amount}
                            </div>
                            <button className='cart__object__increment' onClick={() => handleDecrementAmount(object.objectData.book_id)}>
                                -
                            </button>
                            <div className='cart__object__total-price'>
                                {calculateTotalAmount(object.objectData.price, object.amount)} $
                            </div>
                            <button className='cart__object__remove' onClick={() => handleRemoveFromCart(object.objectData.book_id)}>
                                remove
                            </button>
                        </div>
                    </div>
