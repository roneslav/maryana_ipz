...
import {getDetailedBookInfo} from "../../fetching";
...
const ObjectDetails = () => {
  ...
  return (
    <section>
      ...
      <div className="object-detail__price">Price per 1: {objectsData.price} $</div>
    </section>
  );
}
